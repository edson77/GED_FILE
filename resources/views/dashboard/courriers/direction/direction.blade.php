@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - les courriers reçus @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-8">Les courriers</h1>
                    <div class="dt-page__title col-4"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a> / <span class="text-secondary"> courriers reçus </span>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface permet de gérer les courriers reçus.  </div>
                </div>
  <div class="row">
  ...
  <div class="col-12">
        ...
        <div class="dt-card">
                ...
                <div class="dt-card__body">
                     <div class="row">
                         <div class="col-10"><form class="form-inline" action= "{{route('courrier.search')}} " method="post" >
                                @csrf
                         ...
                         <div class="col-2">
                            <div class="form-group">
                                <a href=" {{route('courriers.print.all')}}"   target="_blank" class="btn btn-info btn-sm">  Imprimer la liste</a>
                            </div> 
                        </div>
