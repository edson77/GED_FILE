@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - les courriers internes @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-6">Les courriers internes supprimés</h1>
                    <div class="dt-page__title col-6"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a> / <a href="{{route('courrier.interne.index')}} "><i class="icon icon-description"></i> Courriers internes</a> / <b class="text-secondary">Courriers supprimés </b>  </div>
                </div>
                                ...
                                <div class="col-4">
                                   <div class="form-group">
                                       @if($courriers->count() > 0)
                                            <a href=" {{route('interne.print.deleted')}}" target="_blank" class="btn btn-info btn-sm">  Imprimer la liste des courriers Internes supprimés</a>
                                       @else
                                            <a href="#" onclick="return alert('Aucun courrier supprimé');" class="btn btn-info btn-sm">  Imprimer la liste des courriers Internes supprimés</a>  
                                       @endif
                                   </div> 
                               </div>
