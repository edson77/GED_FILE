  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-7">Résultat recherche courriers confidentiels</h1>
                    <div class="dt-page__title col-5"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a> / <a href="{{route('courrier.confidentiel')}} "><i class="icon icon-description"></i> Courriers confidentiels</a> / <b class="text-secondary"> Résultats </b>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface affiche les résultats de votre recherche dans les courriers confidentiels.  </div>
                </div>
  <div class="row">
                                ...
                                @foreach ($courriers as $item)
                                  @if($item->deleted == 0)
                                        <tr class="gradeX">
                                                ...
                                                <td style="width: 15%">
                                                    @if( Auth::user()->role == 'Chef service-courrier'  || Auth::user()->role == 'Agent cabinet' || Auth::user()->role == 'Chef agent-cabinet' || Auth::user()->role == 'Agent cabinet' || Auth::user()->role == 'Chef courrier-confidentiel')
                                                        @if($item->nature == 0 )
