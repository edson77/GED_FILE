...
<title>Courriers publics supprimés</title>
    <style type="text/css">
        <!--
...
<div>
    ...
    <br>
    <div>
        <p align="center" class="Style4"><span class="Style8">Liste des courriers publics supprimés </span></p>
