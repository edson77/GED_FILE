@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - Enregistrer courrier public @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-7">Enregistrer un courrier public</h1>
                    <div class="dt-page__title col-5"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a>  / <a href=" {{route('courrier.index')}} "> <i class="icon icon-description"></i> Courriers publics</a> / <b class="text-secondary"> Nouveau </b>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface permet d'Enregistrer un courrier public.  </div>
                </div>
  <div class="row">
            ...
            <form action=" {{route('courrier.store')}} " method="post" enctype="multipart/form-data">
              ...
              <div class="form-group form-row">
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="signataireExt" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   placeholder="Nom de la personne qui a signé le courrier" required>
                        </div>
                </div>
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control form-control-sm" name="type" id="simple-select" required>
                            <option value="" class="text-secondary">Choisir un type de courrier</option>
                ...
                <div class="form-group form-row">
                        <label for="normal-input-5"
                               class="col-md-2 col-sm-3 col-form-label col-form-label-sm text-sm-right">N° Courrier</label>
                        <div class="col-md-10 col-sm-9">
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="ordre" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   placeholder="Numéro d'ordre du courrier" required>
                        </div>
                </div>
                ...
                <div class="form-group form row">
                        <label for="normal-input-5"
                        class="col-md-2 col-sm-3 col-form-label col-form-label-sm text-sm-right">Date initiation</label>
                            ...
                            <!--<input type="hidden" name="reception" id="dtp_input2" value=""  />--><br/>
                </div>
                ...
                <div class="form-group form-row">
                        <label for="normal-input-5"
                            ...
                            <div class="col-md-10 col-sm-9">
                                <select class="form-control form-control-sm" name="destinataire" id="simple-select" required>
