  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-7">Modifier un courrier</h1>
                    <div class="dt-page__title col-5"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a>  /  <b class="text-secondary"> Modifier </b>  </div>
                </div>
            ...
            <form action=" {{route('courrier.update', $courrier->id)}} " method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-row">
                    ...
                    <div class="col-md-10 col-sm-9">
                        <input type="text" class="form-control form-control-sm"
                               id="normal-input-5"
                               name="signataireExt"
                               placeholder="Nom de l'initiateur Externe" 
                               value = {{request()->old('signataire') ? request()->old('signataire') : $courrier->signataire }}
                               >
                    </div>
                </div> 
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control form-control-sm" name="categorie" id="simple-select">
                                <option @if($courrier->categorie == "Correspondance confidentielle") selected="selected" @endif value="Correspondance confidentielle">Correspondance confidentielle</option>
                                <option @if($courrier->categorie == "Dossier disciplinaire") selected="selected" @endif value="Dossier disciplinaire">Dossier disciplinaire</option>
                                <option @if($courrier->categorie == "Courrier confidentiel") selected="selected" @endif value="Courrier confidentiel">Courrier confidentiel</option>
                                <option @if($courrier->categorie == "Courrier Départ Public") selected="selected" @endif value="Courrier Départ Public">Courrier Départ Public</option>
                                <option @if($courrier->categorie == "Courrier Interne") selected="selected" @endif value="Courrier Interne">Courrier Interne</option>
                                <option @if($courrier->categorie == "Autres") selected="selected" @endif value="Autres">Autres</option>
                            </select>
                        </div>
                </div>
                ...
                <div class="form-group form-row">
                        <label class="col-md-2 col-sm-3 col-form-label text-sm-right"
                               for="simple-select">Initiateur Interne </label>
                        ...
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control form-control-sm" name="emetteur" id="simple-select">
                                ...
                                @foreach ($service as $item)
                                    <option @if($courrier->service != NULL && 
                                        $courrier->service == $item->id) selected="selected" @endif  value="{{$item->id}}-service "> {{$item->nom_service}} </option>
                                @endforeach
                            </select>
                        </div>
                </div>
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <select class="form-control form-control-sm" name="type" id="simple-select">
                                ...
                                <option @if($courrier->type == "MRP") selected="selected" @endif value="MRP">MRP</option>
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="numero" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   value="{{request()->old('ordre') ? request()->old('ordre') : $courrier->ordre }}"
                ...
                <div class="form-group form row">
                        ...
                        <div class="input-group date form_date col-md-10 col-sm-9" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" data-target-input="nearest">
                                <input name="reception" class="form-control" size="16" type="date"   value="{{request()->old('reception') ? request()->old('reception') : $courrier->reception}}"  >
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <textarea name="contenu" class="form-control" id="text-area-1" rows="3"placeholder="Decription du courrier (facultatif)">{{$courrier->contenu}} </textarea>
                        </div>
                </div>
                ...
                <div class="form-group form-row" style="text-align: center">
                           <div class="col-9"></div>
                            ...
                            <div style="margin-left:3px">
                                    <a href="{{route('courrier.index')}} " class="btn btn-secondary ">Annuler
                                    </a>
                            </div>
                </div>
