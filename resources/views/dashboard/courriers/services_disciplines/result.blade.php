@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - Résultat de la recherche dans les dossiers disciplinaires @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-8">Résultat de la recherche dans les dossiers disciplinaires</h1>
                    <div class="dt-page__title col-4"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a> / <a href="{{route('courrier.service_discipline')}} "><i class="icon icon-description"></i> Dossiers disciplinaires</a> / <b class="text-secondary"> Résultats </b>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface affiche les résultats de votre recherche dans les dossiers disciplinaires.  </div>
                </div>
  <div class="row">
                                ...
                                @foreach ($courriers as $item)
                                  @if($item->deleted == 0)
                                        <tr class="gradeX">
                                                ...
                                                <td style="width: 15%">
                                                    @if(Auth::user()->role == 'Chef service-courrier'   || Auth::user()->role == 'Agent cabinet' || Auth::user()->role == 'Chef agent-cabinet')
                                                        @if($item->nature == 0 )
