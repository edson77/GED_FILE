    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                ...
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface permet de consulter vos instructions.  </div>
                </div>
  <div class="row">
                            ...
                            <tbody>
                                ...
                                @foreach ($instructions as $item)
                                        <tr class="gradeX">
                                                ...
                                                <td > {{App\User::find(Auth::user()->id)->name}} </td>
