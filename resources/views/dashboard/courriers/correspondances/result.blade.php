@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - Résultat de la recherche dans les correspondances confidentielles @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-7">Résultat recherche correspondances confidentielles</h1>
                    <div class="dt-page__title col-5"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a> / <a href="{{route('courrier.correspondance')}} "><i class="icon icon-description"></i> correspondances confidentielles</a> / <b class="text-secondary"> Résultats </b>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface affiche les résultats de votre recherche dans les correspondances confidentielles.  </div>
                </div>
  <div class="row">
