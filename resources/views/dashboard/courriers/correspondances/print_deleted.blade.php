...
<title>Correspondances confidentielles supprimées</title>
    <style type="text/css">
        <!--
...
<div>
    ...
    <br>
    <div>
        <p align="center" class="Style4"><span class="Style8">Liste des correspondances confidentielles supprimées </span></p>
