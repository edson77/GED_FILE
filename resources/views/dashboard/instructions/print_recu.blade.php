...
<title>Instructions reçus</title>
    <style type="text/css">
        <!--
...
<div>
    ...
    <br>
    <div>
        <p align="center" class="Style4"><span class="Style8">Liste des instructions reçus </span></p>
            ...
            <table width="100%" border="1"  cellspacing="0">
               ...
               @foreach($instructions as $item)
                <tr >
                        ...
                        <td > {{App\Courrier::find($item->courrier)->code}}  </td>
                        <td >  @if($item->direction != null) {{App\Direction::find($item->direction)->nom_direction }} @else {{App\Service::find($item->service)->nom_service }} @endif  </td>
