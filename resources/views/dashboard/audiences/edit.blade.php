@extends('dashboard.layouts.template')
  ...
  @section('title') GED SED - Modifier une audience @stop
  ...
  <div class="dt-content-wrapper">
    ...
    <div class="dt-content">
        ...
        <div class="dt-page__header">
                <div class="row mb-4">
                    <h1 class="dt-page__title col-8">Modifier une audience</h1>
                    <div class="dt-page__title col-4"> <a href="{{route('home')}} "><i class="icon icon-home"></i> Tableau de bord</a>  / <a href=" {{route('audiences.index')}} "> <i class="icon icon-eye"></i> Audiences</a> / <b class="text-secondary"> Modifier </b>  </div>
                </div>
                <div class="alert alert-info mb-3 alert-dismissible fade show col-12" role="alert">
                        <div> <i class="icon icon-info text-secondary" style="font-size: 30px"></i>  Cette interface permet de modifier une audience.  </div>
                </div>
  <div class="row">
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="guest" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   value=" {{request()->old('guest') ? request()->old('guest') : $audience->guest }} "
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="phone" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   value=" {{request()->old('phone') ? request()->old('phone') : $audience->phone}} "
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="quality" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   value=" {{request()->old('quality') ? request()->old('quality') : $audience->quality}} "
                ...
                <div class="form-group form-row">
                        ...
                        <div class="col-md-10 col-sm-9">
                            <input type="text" name="objet" class="form-control form-control-sm"
                                   id="normal-input-5"
                                   value = " {{request()->old('objet') ? request()->old('objet') : $audience->objet }} "
